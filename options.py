...
class Options:
    ...
    def __init__(self):
        ...
        self.__add_common_ssh_options(parser_a)

        parser_b = subparsers.add_parser(Options.COMMAND_DESTROY, help='Destroys the cluster')
        self.__add_common_ssh_options(parser_b)
