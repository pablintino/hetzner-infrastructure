import interfaces.ansible.kubespray_manager
...
def test_basic_exmaple():
    ...
    inventory = interfaces.ansible.kubespray_manager.build_inventory(server_list)
